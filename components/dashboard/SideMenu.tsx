...
export default async function SideMenu() {
  ...
  return (
    <aside className="bg-black-500 absolute z-50 mx-auto box-border h-full shrink-0 flex-col border-r border-gray-900 py-2 md:static md:flex md:w-[220px] md:w-[clamp(200px,calc(50.78vw-190px),330px)]">
      <SidebarHeader />
